  ...
  render() {
    return (
      <Container style={{paddingTop: "2rem"}}>
        ...
        <Row>
          <Col xs="1"></Col>
          <Col><div style={{textAlign: "center", fontSize: "18px"}}>Click <a className="underLine" onClick={this.ReloadWindow} name="/" href="/">here</a> to go back to the homepage.</div></Col>
          <Col xs="1"></Col>
        </Row>
        <Row>
        <Col xs="1"></Col>
